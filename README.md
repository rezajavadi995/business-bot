...
## نکات اصلی نسخه فعلی
- تمام متن‌های داخل خود ربات فارسی هستند.
- بخش «تعرفه» از ربات حذف شده است.
- گزارش وضعیت ادمین شامل: آیدی عددی + یوزرنیم + نام پروفایل کاربران است.
- فیچر Bold اکنون واقعی است و با `admin_bold_mode` اعمال می‌شود.
- هیچ «هارد ساب» اجباریِ ثابت در کد وجود ندارد؛ مقدار کانال فقط از تنظیمات می‌آید.
